...
{
    public partial class Canvas : IRendererExtended
    {
        ...
        {
            ((IRendererExtended)Renderer).DrawBackground();
        }
        ...
        public void DrawEllipse(float diameter)
        {
            ((IRendererExtended)Renderer).DrawEllipse(diameter);
        }

        public void DrawEllipse(float width, float height)
        {
            ((IRendererExtended)Renderer).DrawEllipse(width, height);
        }
        ...
        {
            ((IRendererExtended)Renderer).DrawCircle(x, y, diameter);
        }
        ...
        {
            ((IRendererExtended)Renderer).DrawPoint();
        }
        ...
        public void DrawRectangle(float size)
        {
            ((IRendererExtended)Renderer).DrawRectangle(size);
        }

        public void DrawRectangle(float width, float height)
        {
            ((IRendererExtended)Renderer).DrawRectangle(width, height);
        }
        ...
        {
            ((IRendererExtended)Renderer).DrawSquare(x, y, size);
        }

        public void DrawText(object text)
        {
            ((IRendererExtended)Renderer).DrawText(text);
        }
