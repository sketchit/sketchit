...
namespace SketchIt.Api.Static
{
    ...
    {
        public static AngleMode AngleMode = AngleMode.Degrees;
        ...
        {
            return _perlin.noise(x, y, z);
        }

        public static float Noise(float x, float y)
        {
            return _perlin.noise(x, y, 0);
        }

        public static float Noise(float x)
        {
            return _perlin.noise(x, 0, 0);
        }
        ...
        {
            float value = Max(Min((float)_random.NextGaussian(), 3), -3);
            return Map(value, -3, 3, 0, 1);
        }
        ...
        {
            return (float)Math.Cos(AngleMode == AngleMode.Degrees ? Radians(angle) : angle);
        }

        public static float Sin(float angle)
        {
            return (float)Math.Sin(AngleMode == AngleMode.Degrees ? Radians(angle) : angle);
        }

        public static float Tan(float angle)
        {
            return (float)Math.Tan(AngleMode == AngleMode.Degrees ? Radians(angle) : angle);
        }

        public static float Sinh(float angle)
        {
            return (float)Math.Sinh(AngleMode == AngleMode.Degrees ? Radians(angle) : angle);
        }

        public static float Tanh(float angle)
        {
            return (float)Math.Tanh(AngleMode == AngleMode.Degrees ? Radians(angle) : angle);
        }
        ...
        public static float Constrain(float number, float limit1, float limit2)
        {
            if (limit1 < limit2)
            {
                return number < limit1 ? limit1
                    : number > limit2 ? limit2
                    : number;
            }
            else
            {
        ...
        public static float Lerp(float start, float stop, float value)
        {
