    ...
    public partial class Sketch
    {
        ...
        private void Start(IApplet applet, ISketchContainer canvas, int retries)
        {
            if (UseDefaultConsole)
            {
                ...
                //    }
                //}
                StartSketch(new object[] { applet, canvas, retries });
            ...
            else
            {
                ...
                _setupThread = new Threading.Thread(start);
                _setupThread.Start(new object[] { applet, canvas, retries });
            }
        }
        ...
        private void Initialize()
        {
            ...
            _setupCompleted = _methodSetup == null;
            _initialized = true;
        }
        ...
        public void Paint(Graphics graphics, Size size)
        {
            ...
            {
                PrintLine(ex.Message + Environment.NewLine + ex.StackTrace);
            }
            finally
            {
                Graphics = null;
