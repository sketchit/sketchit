...
namespace SketchIt.Api
{
    ...
    public class Style : IStyle
    {
        ...
        public BackgroundParameters BackgroundParameters { get; private set; }
        ...
        public Style()
        {
            ...
            BackgroundParameters = new BackgroundParameters(new Color(100));
        }

        public void SetBackground(BackgroundParameters parms)
        {
            BackgroundParameters = parms;
        }
        ...
        public Rectangle GetAdjustedRectangle(RectangleParameters parms) => GetAdjustedRectangle((int)RectangleMode, parms.X, parms.Y, parms.Width, parms.Height);
        public Rectangle GetAdjustedRectangle(ArcParameters parms) => GetAdjustedRectangle((int)EllipseMode, parms.X, parms.Y, parms.Width, parms.Height);
        public Rectangle GetAdjustedRectangle(EllipseParameters parms) => GetAdjustedRectangle((int)EllipseMode, parms.X, parms.Y, parms.Width, parms.Height);
        public Rectangle GetAdjustedRectangle(ImageParameters parms) => GetAdjustedRectangle((int)ImageMode, parms.X ?? 0, parms.Y ?? 0, parms.Width ?? parms.Image.Width, parms.Height ?? parms.Image.Height);
        public Rectangle GetAdjustedRectangle(int mode, float x, float y, float width, float height)
        {
            switch (mode)
            {
