...
{
    public partial class Sketch : IStyleExtended
    {
        ...
        public void SetTint(float gray) { SetTint(new TintParameters(GetColor(gray))); }
        public void SetTint(float gray, float alpha) { SetTint(new TintParameters(GetColor(gray, alpha))); }
        public void SetTint(float r, float g, float b) { SetTint(new TintParameters(GetColor(r, g, b))); }
        public void SetTint(float r, float g, float b, float alpha) { SetTint(new TintParameters(GetColor(r, g, b, alpha))); }
