...
namespace SketchIt.Api.Renderers
{
    ...
    public abstract class RendererBase : IRenderer, IRendererExtended
    {
        ...
        public virtual void SetBackground(BackgroundParameters parms)
        {
            Style.SetBackground(parms);
        }
        ...
        public virtual void SetLights() => NotImplemented();
        #endregion
        ...
        public void DrawEllipse(float diameter) => DrawEllipse(new EllipseParameters(0, 0, diameter));
        public void DrawEllipse(float width, float height) => DrawEllipse(new EllipseParameters(0, 0, width, height));
        ...
        public void DrawCircle(float x, float y, float diameter) => DrawEllipse(x, y, diameter);
        public void DrawLine(float x1, float y1, float x2, float y2) => DrawLine(new LineParameters(x1, y1, x2, y2));
        public void DrawPoint() => DrawPoint(new PointParameters(0, 0));
        ...
        public void DrawRectangle(float size) => DrawRectangle(new RectangleParameters(0, 0, size, size));
        public void DrawRectangle(float width, float height) => DrawRectangle(new RectangleParameters(0, 0, width, height));
        ...
        public void DrawSquare(float x, float y, float size) => DrawRectangle(x, y, size);
        public void DrawText(object text) => DrawText(new TextParameters(text, 0, 0));
        ...
        public void DrawImage(IImage image) => DrawImage(new ImageParameters(image, 0, 0));
        ...
        public void DrawBackground() => DrawBackground(Style.BackgroundParameters);
